...
class ImgModule extends React.Component {
	state = {
		typeList:[{id:1,name:'along1',sourceNum:15},{id:1,name:'along2',sourceNum:153},{id:1,name:'along3',sourceNum:15},{id:1,name:'along4',sourceNum:151},{id:1,name:'along5',sourceNum:15}],
		imgList:[{id:1,url:"http://rongyi.b0.upaiyun.com/system/smartService/null/201801180034041097.png"
