...
class IscrollAlong extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      options: {
        ...
        pulldownInfo: '下拉刷新',//下拉刷新
        pulldownReadyInfo: '松开刷新',//松开刷新
        pulldowningInfo: '刷新中…',//刷新中…
        pullupInfo: '加载更多',//加载更多
        // pullupReadyInfo: '',/松开加载
        pullupingInfo: '加载中…',//加载中…
      },
      boxHeight: 0,
    };
  ...
  /** children内容改变时触发,表示已完成了刷新或加载 **/
    componentWillReceiveProps(nextP, prevState) {
