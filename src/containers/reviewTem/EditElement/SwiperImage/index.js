...
import './index.less'
import { content_do,everySame,destroySwiper,formatObj,sameCheck } from 'compEdit/EditElement/SwiperImage/content_do'
 
class RYSwiperShow extends React.Component {
	state = {
		content:'',
