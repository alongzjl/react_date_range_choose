...
class RyEditableBind extends React.Component {
        ...
        if ($ryEditable && !this.state.isMouseDown) {
            ...
            if (this.props.config && this.props.config.bClone) {
                ...
                if ($target.hasClass('ui-resizable-se')) {
                    ...
                    // 右下角
                    this.state.boxMinWidth = Math.max(this.state.minWidth, $ryEditable.find('.ui-btns').width() + 6);
                    ...
                    this.state.boxMinWidth = Math.max(this.state.minWidth, $ryEditable.find('.ui-btns').width() + 6);
                    this.state.boxMaxWidth = this.state.beforePos.left + this.state.beforePos.width;
                    this.state.boxMinHeight = this.state.minHeight;
                    this.state.boxMaxHeight = parentHeight - this.state.beforePos.top;
                    ...
                    this.state.boxMaxWidth = this.state.beforePos.left + this.state.beforePos.width;
                    this.state.boxMinHeight = this.state.minHeight;
                    this.state.boxMaxHeight = this.state.beforePos.top + this.state.beforePos.height;
                    ...
                    this.state.boxMinWidth = Math.max(this.state.minWidth, $ryEditable.find('.ui-btns').width() + 6);
                    this.state.boxMaxWidth = parentWidth - this.state.beforePos.left; // this.state.beforePos.left + this.state.beforePos.width;
                    this.state.boxMinHeight = this.state.minHeight;
                    this.state.boxMaxHeight = this.state.beforePos.top + this.state.beforePos.height; // parentHeight - this.state.beforePos.top;
   ...
   */
    moveSE(e) {
        // 右下角
        e.preventDefault();
        let newWidth = this.getWidth(e.pageX - this.state.beforePos.pageX + this.state.beforePos.width, 2);
        let newHeight = this.getHeight(e.pageY - this.state.beforePos.pageY + this.state.beforePos.height, 2);
   ...
   */
    moveNW(e) {
        // 左上角
        e.preventDefault();
        let newWidth = this.getWidth(-(e.pageX - this.state.beforePos.pageX) + this.state.beforePos.width);
        let newHeight = this.getHeight(-(e.pageY - this.state.beforePos.pageY) + this.state.beforePos.height);
        let wh = this.getWidthAndHeight(newWidth, newHeight, 2);

        this.setCss({
            top: this.getTop(this.state.beforePos.top + this.state.beforePos.height - wh.height, 1),
            left: this.getLeft(this.state.beforePos.left + this.state.beforePos.width - wh.width, 1),
            width: wh.width,
            height: wh.height
        });
    }
   ...
   */
    moveSelf(e) {
        ...
        if (this.state.clickArea === 'body' && this.state.beforePos.item.move) {
            ...
            this.moveSE(e);
        } else if (this.state.clickArea === 's' && this.state.beforePos.item.resize) {
            this.moveS(e);
        } else if (this.state.clickArea === 'e' && this.state.beforePos.item.resize) {
            this.moveE(e);
        } else if (this.state.clickArea === 'nw' && this.state.beforePos.item.resize) {
            this.moveNW(e);
        } else if (this.state.clickArea === 'w' && this.state.beforePos.item.resize) {
            this.moveW(e);
        } else if (this.state.clickArea === 'n' && this.state.beforePos.item.resize) {
            this.moveN(e);
        } else if (this.state.clickArea === 'sw' && this.state.beforePos.item.resize) {
            this.moveSW(e);
        } else if (this.state.clickArea === 'ne' && this.state.beforePos.item.resize) {
            this.moveNE(e);
        }
    }
    /**
