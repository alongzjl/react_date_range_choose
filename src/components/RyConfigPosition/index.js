 ...
 * @Last modified time: 2018-04-21T18:35:38+08:00
 */
                ...
                <RyBorder>
                    ...
                    <ul className="ui-form-ul clearfix">
                        <li className="ui-form-li is-half">
                            ...
                            <TextInputComponent text={this.props.range.styleTop} onInput={()=>{this.changeStyle('top')}} />
                        </li>
                        <li className="ui-form-li is-half">
                            <label className="ui-form-lbl">左</label>
                            <TextInputComponent text={this.props.range.styleLeft} onInput={()=>{this.changeStyle('left')}} />
                        </li>
                    </ul>
                    ...
                    <ul className="ui-form-ul clearfix">
                        <li className="ui-form-li is-half">
                            ...
                            <TextInputComponent text={this.props.range.styleWidth} onInput={()=>{this.changeStyle('width')}} />
                        </li>
                        <li className="ui-form-li is-half">
                            <label className="ui-form-lbl">高度</label>
                            <TextInputComponent text={this.props.range.styleHeight} onInput={()=>{this.changeStyle('height')}} />
                        </li>
                        <li style="clear: both;">
                            <label className="ui-form-lbl">&nbsp;</label>
                            <RyCheckbox click="vm.changeRadio()" ng-model="range.radio" read-only="focusItem.type === 4">
